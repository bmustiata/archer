...
if (shellParameters.list) {
    ListProjects_1.listProjects(shellEnvironment);
}
    ...
    if (!shellParameters._.length) {
        EmptyRun_1.emptyProjectsRun(shellEnvironment);
    }
    else {
        SelectProject_1.selectProject(shellEnvironment, shellParameters._);
    }
}
